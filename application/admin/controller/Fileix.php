                ...
                if ( $_POST["action"] == "download" ) {
                    ...
                    if ( $_POST["action"] == "preview" ) {
                        ...
                        if ( $_POST["action"] == "remove" ) {
                            echo json_encode($api->batch($_POST["source"], [ $api, "rm" ]));
                        } else {
                            if ( $_POST["action"] == "copy" ) {
                                echo json_encode($api->batch($_POST["source"], [ $api, "cp" ], $_POST["target"]));
                            } else {
                                if ( $_POST["action"] == "move" ) {
                                    echo json_encode($api->batch($_POST["source"], [ $api, "mv" ], $_POST["target"]));
                                } else {

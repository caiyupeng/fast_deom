            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    <div id="toolbar" class="toolbar">
                        ...
                        <a href="javascript:;"
                           class="btn btn-success btn-add <?php echo $auth->check('article/category/add')?'':'hide'; ?>"
                           title="<?php echo __('Add'); ?>"><i class="fa fa-plus"></i> <?php echo __('Add'); ?></a>
                        <a href="javascript:;"
                           class="btn btn-success btn-edit btn-disabled disabled <?php echo $auth->check('article/category/edit')?'':'hide'; ?>"
                           title="<?php echo __('Edit'); ?>"><i class="fa fa-pencil"></i> <?php echo __('Edit'); ?></a>
                        <a href="javascript:;"
                           class="btn btn-danger btn-del btn-disabled disabled <?php echo $auth->check('aarticle/category/del')?'':'hide'; ?>"
                    ...
                    <table id="table" class="table table-bordered table-hover"
                           data-operate-edit="<?php echo $auth->check('article/category/edit'); ?>"
                           data-operate-del="<?php echo $auth->check('article/category/del'); ?>"
                           width="100%">
                    </table>
                </div>
            </div>

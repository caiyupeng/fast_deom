            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    <div id="toolbar" class="toolbar">
                        ...
                        <!--<a href="javascript:;" class="btn btn-danger btn-import <?php echo $auth->check('wechatapp/user/import')?'':'hide'; ?>" title="<?php echo __('Import'); ?>" id="btn-import-file" data-url="ajax/upload" data-mimetype="csv,xls,xlsx" data-multiple="false"><i class="fa fa-upload"></i> <?php echo __('Import'); ?></a>-->

                        <!--<div class="dropdown btn-group <?php echo $auth->check('wechatapp/user/multi')?'':'hide'; ?>">-->
                    ...
                    <table id="table" class="table table-striped table-bordered table-hover table-nowrap"
                           data-operate-edit="<?php echo $auth->check('wechatapp/user/edit'); ?>" 
                           data-operate-del="<?php echo $auth->check('wechatapp/user/del'); ?>" 
                           width="100%">
                    </table>
                </div>
            </div>

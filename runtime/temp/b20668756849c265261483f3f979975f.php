...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-appsecret" data-rule="required" class="form-control" name="row[appsecret]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-accesstoken" class="form-control" name="row[accesstoken]" type="text">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-encodingaeskey" class="form-control" name="row[encodingaeskey]" type="text">
        </div>
    </div>
    <div class="form-group">

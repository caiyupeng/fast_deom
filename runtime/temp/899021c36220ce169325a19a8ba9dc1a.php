<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:91:"Z:\Applications\MAMP\htdocs\fastadmindemo\public/../application/admin\view\index\index.html";i:1547349022;s:81:"Z:\Applications\MAMP\htdocs\fastadmindemo\application\admin\view\common\meta.html";i:1547349022;s:83:"Z:\Applications\MAMP\htdocs\fastadmindemo\application\admin\view\common\header.html";i:1551940717;s:81:"Z:\Applications\MAMP\htdocs\fastadmindemo\application\admin\view\common\menu.html";i:1551940883;s:84:"Z:\Applications\MAMP\htdocs\fastadmindemo\application\admin\view\common\control.html";i:1551940659;s:83:"Z:\Applications\MAMP\htdocs\fastadmindemo\application\admin\view\common\script.html";i:1547349022;}*/ ?>
<!DOCTYPE html>
...
<aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="control-sidebar-setting-tab">
            ...
            <div class="form-group"><label class="control-sidebar-subheading"><input type="checkbox" data-layout="fixed"
                                                                                     class="pull-right"> <?php echo __('Fixed
                Layout'); ?></label>
                <p><?php echo __("You can't use fixed and boxed layouts together"); ?></p></div>
            <div class="form-group"><label class="control-sidebar-subheading"><input type="checkbox"
                                                                                     data-layout="layout-boxed"
                                                                                     class="pull-right"> <?php echo __('Boxed
                Layout'); ?></label>
                <p><?php echo __('Activate the boxed layout'); ?></p></div>
            <div class="form-group"><label class="control-sidebar-subheading"><input type="checkbox"
                                                                                     data-layout="sidebar-collapse"
                                                                                     class="pull-right"> <?php echo __('Toggle
                Sidebar'); ?></label>
                <p><?php echo __("Toggle the left sidebar's state (open or collapse)"); ?></p></div>
            <div class="form-group"><label class="control-sidebar-subheading"><input type="checkbox"
                                                                                     data-enable="expandOnHover"
                                                                                     class="pull-right"> <?php echo __('Sidebar
                Expand on Hover'); ?></label>
                <p><?php echo __('Let the sidebar mini expand on hover'); ?></p></div>
            <div class="form-group"><label class="control-sidebar-subheading"><input type="checkbox"
                                                                                     data-menu="show-submenu"
                                                                                     class="pull-right"> <?php echo __('Show sub
                menu'); ?></label>
                <p><?php echo __('Always show sub menu'); ?></p></div>
            <div class="form-group"><label class="control-sidebar-subheading"><input type="checkbox"
                                                                                     data-menu="disable-top-badge"
                                                                                     class="pull-right"> <?php echo __('Disable
                top menu badge'); ?></label>
                <p><?php echo __('Disable top menu badge without left menu'); ?></p></div>
            <div class="form-group"><label class="control-sidebar-subheading"><input type="checkbox"
                                                                                     data-controlsidebar="control-sidebar-open"
                                                                                     class="pull-right"> <?php echo __('Toggle
                Right Sidebar Slide'); ?></label>
                <p><?php echo __('Toggle between slide over content and push content effects'); ?></p></div>
            <div class="form-group"><label class="control-sidebar-subheading"><input type="checkbox"
                                                                                     data-sidebarskin="toggle"
                                                                                     class="pull-right"> <?php echo __('Toggle
                Right Sidebar Skin'); ?></label>
                <p><?php echo __('Toggle between dark and light skins for the right sidebar'); ?></p></div>
